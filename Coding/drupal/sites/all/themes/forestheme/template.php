 ...
 */
//$file_path = module_load_include('inc', 'social_media_links', 'social_media_links.iconsets');
//
//if ($file_path === FALSE) {
...
//    }
//
//    function social_media_links_path_foreicon($platform = 'twitter', $style = NULL) {
//        $info = social_media_links_iconset('foreicons');
//
//        switch ($platform) {
//            case 'contact':
//                $platform = 'email';
 ...
 */
function forestheme_on_the_web_image($variables) {
